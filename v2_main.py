...
away_batters_dict = get_batter_data(away_batters, away_list[0])
home_batters_dict = get_batter_data(home_batters, home_list[0])
...
for reliever in away_bullpen:
    if away_pitcher in reliever:
        ...
        break
if away_closer == '':
    away_pitchers_dict = get_pitcher_data([away_pitcher] + away_bullpen, away_list[0])
else:
    away_pitchers_dict = get_pitcher_data([away_pitcher, away_closer] + away_bullpen, away_list[0])
...
for reliever in home_bullpen:
    if home_pitcher in reliever:
        ...
        break
if home_closer == '':
    home_pitchers_dict = get_pitcher_data([home_pitcher] + home_bullpen, home_list[0])
else:
    home_pitchers_dict = get_pitcher_data([home_pitcher, home_closer] + home_bullpen, home_list[0])
